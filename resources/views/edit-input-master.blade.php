                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="noHp" class="form-control" autocomplete="off" value="{{ $dataTelp->no_telp }}" required>
                                    <input type="hidden" name="idData" value="{{ $dataTelp->id }}">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label for="nama">Nama</label>
                                    <input type="text" name="nama" class="form-control" autocomplete="off" value="{{ $dataTelp->nama }}">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                            ...
                            <div class="col-lg-12 col-md-12 tgltelp" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgltelp" id="tgltelp" class="form-control" autocomplete="off" value="{{ $dataTelp->tgl_telp }}">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
...
<script>
    $(function(){
        ...
        @if($dataTelp->sudah_ditelp === 'Y' )
            _telpStatus = 'Y';
            document.getElementById('cbTelpStatus').checked = true;
            $('.tgltelp').show();
        @else
            _telpStatus = 'N';
            document.getElementById('cbTelpStatus').checked = false;
            $('.tgltelp').hide();
        @endif
